  ...
  <div class="row">
    <div class="col s12 m8 offset-m2">
      <ul class="tabs">
        ...
        <li class="tab col s6"><a href="#developer">Developer</a></li>
      </ul>
    </div>
  </div>
  ...
  <div id="developer" class="col s12">
    <div class="card hoverable z-depth-3">
      <div class="card-content center-align">
        <img src="/profile.jpg" alt="Abdullah Zafar" class="profile-img z-depth-1 tooltipped" data-tooltip="Abdullah Zafar">
        <span class="card-title">Abdullah Zafar</span>
        <p><em class="indigo-text">@raz0229</em></p>
        <p>Registration: <b>L1F23BSAI0054</b></p>
